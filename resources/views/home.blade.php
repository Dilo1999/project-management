            ...
            <div class="px-6 md:px-8 pb-10">
                ...
                @if($projects->isEmpty())
                    <div class="bg-white rounded-xl border-2 border-dashed border-gray-200 py-12 text-center shadow-sm">
                        <p class="text-gray-400 text-sm">No projects added yet.</p>
                        <p class="text-gray-300 text-xs mt-1">
                            Use the &ldquo;Add Project&rdquo; page to create your first project.
                        </p>
                    </div>
                @else
